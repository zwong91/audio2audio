...
def parse_args():
    ...
    parser.add_argument("--certfile", type=str, default="cf.key", help="Path to SSL certificate file")
    parser.add_argument("--keyfile", type=str, default="cf.pem", help="Path to SSL key file")
